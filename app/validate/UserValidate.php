...
class UserValidate extends Validate
{
    ...
    protected $message = [
        ...
        'username.regex' => ['code' => 500, 'message' => '帐号由请输入6-12位英文或数字'],
        //密码
        'password.require' => ['code' => 500, 'message' => '密码 不能为空'],
        'password.regex' => ['code' => 500, 'message' => '密码(请输入6-11位英文或数字'],


        //姓名
        'name.require' => ['code' => 500, 'message' => '姓名不能为空'],
        'name.regex' => ['code' => 500, 'message' => '为保证资金安全, 请填写真实姓名2-4位'],
        //QQ
